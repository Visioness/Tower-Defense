...
def main():
    ...
    spawn_enemy(enemy_group, enemy_image, waypoints, 200, 0.5)
    spawn_enemy(enemy_group, enemy_image, waypoints, 200, 0.4)
    spawn_enemy(enemy_group, enemy_image, waypoints, 200, 0.6)
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                if base_selected:
                    ...
                    if build_button.draw(screen):
                        ...
                        if (base[0], base[1] - 6) in tower_pos_list:
                            index = tower_pos_list.index((base[0], base[1] - 6))
